				...
				<div class="wrap-iten-in-cart">
					@if(Session::has('success_message'))
						<div class="alert alert-success">
							<strong>Успех</strong> {{ Session::get('success_message')}}
						</div>
					@endif
					@if(Cart::count() > 0)
					...
					<ul class="products-cart">
						...
						<li class="pr-cart-item">
							...
							<div class="product-name">
								<a class="link-to-product" href="{{ route('product.details',['slug'=>$item->model->slug]) }}">{{ $item->model->nmae }}</a>
							</div>
							<div class="price-field produtc-price"><p class="price">${{ $item->model->regular_price }}</p></div>
							<div class="quantity">
								<div class="quantity-input">
									<input type="text" name="product-quatity" wire:change="changeQty('{{  $item->rowId}}',$event.target.value)" value="{{ $item->qty }}" data-max="120" pattern="[0-9]*">
